...
def db(monkeypatch):
    ...
    Base.metadata.create_all(eng, tables=[UniverseSnapshot.__table__, GrowthMetric.__table__])
...
def db_peer(monkeypatch):
    ...
    Base.metadata.create_all(
        ...
        tables=[
            ...
            GrowthMetric.__table__,
            Financial.__table__,
            SectorTheme.__table__,
            SectorThemeStock.__table__,
        ],
    )
